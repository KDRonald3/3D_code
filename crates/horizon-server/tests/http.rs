...
async fn serves_index_and_static_assets() {
    ...
    for (uri, needle) in [
        ...
        ("/static/viewer.css", "side-rail squeeze must never grow this bar"),
        ("/static/viewer.css", "white-space: nowrap"),
        // Narrow centre column: compact labels (not wrap); height stays 40px.
        ("/static/viewer.css", "flex: 0 0 40px"),
        ("/static/viewer.css", "max-height: 40px"),
        ("/static/viewer.css", ".bottom-chrome.is-compact"),
        ("/static/viewer.css", ".bottom-chrome.is-tight"),
        ("/static/viewer.css", "scrollbar-width: none"),
        ("/static/viewer.js", "BOTTOM_CHROME_COMPACT_PX"),
        ("/static/viewer.js", "BOTTOM_CHROME_TIGHT_PX"),
        ("/static/viewer.js", "syncBottomChromeCompact"),
        ("/static/viewer.js", "contentTopInset"),
        ("/static/viewer.js", "chromeHeight"),
        ("/static/viewer.js", "chromeWidth"),
        ("/", "chrome-label-short"),
        ("/", "chrome-tab-short"),
        ("/", "class=\"ghost-btn bottom-close\""),
